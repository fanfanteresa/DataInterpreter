...
from actions.di.ask_review import AskReview, ReviewConst
from actions.di.write_plan import (
    WritePlan,
...
class Planner(BaseModel):
    ...
    def get_plan_status(self) -> str:
        ...
        # guidance = scene.get_task_guidance(task_type_name)
        guidance = SCENE_REGISTRY.get_task_guidance(task_type_name)
