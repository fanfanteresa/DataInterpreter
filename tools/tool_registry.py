...
from const import TOOL_SCHEMA_PATH
from logs import logger
from tools.tool_convert import convert_code_to_tool_schema
from tools.tool_data_type import Tool, ToolSchema
...
def register_tool(tags: list[str] = None, schema_path: str = "", **kwargs):
    ...
    def decorator(cls):
        ...
        file_path = file_path.split("dataInterpreter/")[-1]
